...
- You'll need to use high-quality HTTPS proxies. Otherwise, run the script without proxy. <br> Free proxies won't work.
- The recommended number of threads is around 2-5 without proxies. <br> With proxies, you can set a higher number of threads.
